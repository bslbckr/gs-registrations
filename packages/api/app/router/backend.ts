...
type DbResult = { id: number, team: string, city: string, strength: number, contact: string, email: string, comment: string, registration_date: string, confirmed: number, paid: number, waiting_list: number, position: number };
type JsonResult = { id: number, team: string, city: string, strength: number, contact: string, email: string, comment: string, registrationDate: string, confirmed: boolean, paid: boolean, waitingList: boolean, position: number };
